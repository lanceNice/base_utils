...
class RedisHelper(object):
    ...
    def public(self, chan_pub, msg):
        ...
        self.__redis.publish(chan_pub, msg)
        return True
...
if __name__ == '__main__':
    _redis = RedisHelper()
    # _redis.set_lpush("test", 1, 2, 3, 4)
    # print(_redis.set_rpush('test', 1))
    # print(_redis.len_list("test"))
    # a = ""
    # _redis.set("company_data", "")

    pub = _redis.subscribe("test")
    while True:
